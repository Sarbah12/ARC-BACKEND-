...
import alumniHandler        from './api/alumni.js';
import alumniMeHandler      from './api/alumni/me.js';
...
import adminAlumniHandler   from './api/admin/alumni.js';
...
app.all('/api/alumni/me',     publicLimiter, alumniMeHandler);
app.all('/api/alumni',        publicLimiter, alumniHandler);
app.all('/api/reports',       publicLimiter, reportsHandler);
...
app.all('/api/admin/alumni',      adminLimiter, adminAlumniHandler);
app.all('/api/admin/reports',     adminLimiter, adminReportsHandler);
